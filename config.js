...
module.exports = {
    ...
    PHONE: process.env.NUMBER === undefined ? '+703148103' : process.env.NUMBER,   
    OA_NAME: process.env.DEPLOYER === undefined ? '𝒦𝒜𝒱𝐸𝐸' : process.env.DEPLOYER,
    ALL: process.env.ALL_CAPTION === undefined ? 'Made By 𝒦𝒜𝒱𝐸𝐸 X' : process.env.ALL_CAPTION,
    LG_LOGO: process.env.LG_LOGO === undefined ? 'https://ibb.co/Cb5nqQd' : process.env.LG_LOGO,
    LOGO_NAME: process.env.LOGO_NAME === undefined ? '𝒦𝒜𝒱𝐸𝐸' : process.env.LOGO_NAME,
    CODE: process.env.C_CODE === undefined ? '91' : process.env.C_CODE,
    MENTION: process.env.TAG_REPLY === undefined ? '703148103@s.whatsapp.net' : process.env.TAG_REPLY,
